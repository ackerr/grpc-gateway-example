...
func (c *exampleServiceClient) Echo(ctx context.Context, in *ExampleRequest, opts ...grpc.CallOption) (*ExampleResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ExampleService/Echo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedExampleServiceServer) Echo(context.Context, *ExampleRequest) (*ExampleResponse, error) {
...
func _ExampleService_Echo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ExampleService/Echo",
	}
